...
(:types
	...
	grass water leaves torch log wheat_seeds farmland oak_door grass_path ladder flower cobblestone planks gravel glass fence chest cobblestone_stairs grass_block dirt - item
	grass-block water-block leaves-block torch-block log-block wheat_seeds-block farmland-block oak_door-block grass_path-block ladder-block flower-block cobblestone-block planks-block gravel-block glass-block fence-block chest-block cobblestone_stairs-block grass_block-block dirt-block - destructible-block
)
(:predicates

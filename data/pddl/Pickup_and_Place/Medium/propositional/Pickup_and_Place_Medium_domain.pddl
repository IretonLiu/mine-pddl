...
(:types
	...
	planks dirt cobblestone stone_bricks stone grass_block - item
	planks-block dirt-block cobblestone-block stone_bricks-block stone-block grass_block-block - destructible-block
)
(:predicates

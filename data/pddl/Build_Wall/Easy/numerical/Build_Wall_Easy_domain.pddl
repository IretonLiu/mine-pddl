...
(:types
	...
	cobblestone grass_block planks log stone - item
	cobblestone-block grass_block-block planks-block log-block stone-block - destructible-block
)
(:predicates
	(item-present ?i - item)
...
(block-present ?b) (= (x ?b) 4) (= (y ?b) 4) (= (z ?b) 1)))
	(exists (?b - log-block) (and 
(block-present ?b) (= (x ?b) 3) (= (y ?b) 4) (= (z ?b) 1)))
	(exists (?b - log-block) (and 
(block-present ?b) (= (x ?b) 5) (= (y ?b) 6) (= (z ?b) 1)))
	(exists (?b - log-block) (and 
(block-present ?b) (= (x ?b) 4) (= (y ?b) 6) (= (z ?b) 1)))
	(exists (?b - log-block) (and 
(block-present ?b) (= (x ?b) 3) (= (y ?b) 6) (= (z ?b) 1)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) 5) (= (y ?b) 5) (= (z ?b) 1)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) 3) (= (y ?b) 5) (= (z ?b) 1)))

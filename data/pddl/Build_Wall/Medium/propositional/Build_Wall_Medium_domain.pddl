...
(:types
	...
	stone_bricks planks log grass_block cobblestone wool stone - item
	stone_bricks-block planks-block log-block grass_block-block cobblestone-block wool-block stone-block - destructible-block
)
(:predicates
...
(:action move_and_pickup-wool-north
	:parameters (?ag - agent ?i - wool ?x - position ?y_up - position ?y_down - position ?y_2_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action move_and_pickup-wool-east
	:parameters (?ag - agent ?i - wool ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_down - position ?y_2_down - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)

...
(:types
	...
	planks cobblestone wheat_seeds log grass grass_block oak_door grass_path gravel dirt leaves farmland cobblestone_stairs fence water glass chest torch ladder flower - item
	planks-block cobblestone-block wheat_seeds-block log-block grass-block grass_block-block oak_door-block grass_path-block gravel-block dirt-block leaves-block farmland-block cobblestone_stairs-block fence-block water-block glass-block chest-block torch-block ladder-block flower-block - destructible-block
)
(:predicates
...
(block-present ?b) (= (x ?b) 1) (= (y ?b) 6) (= (z ?b) 11)))
	(exists (?b - log-block) (and 
(block-present ?b) (= (x ?b) 0) (= (y ?b) 6) (= (z ?b) 11)))
	(exists (?b - log-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 6) (= (z ?b) 11)))
...
(block-present ?b) (= (x ?b) 0) (= (y ?b) 5) (= (z ?b) 11)))
	 )
	:effect (and 
(goal-achieved ?ag))
)

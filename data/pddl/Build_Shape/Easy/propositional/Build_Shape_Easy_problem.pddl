(define (problem Build_Shape_Easy_problem)
	(:domain Build_Shape_Easy)
(:objects
	steve - agent
	...
	planks0 - planks
	planks-block0 planks-block1 planks-block2 planks-block3 planks-block4 planks-block5 - planks-block
...
(:init
	...
	(agent-has-n-cobblestone steve count5)

	(agent-has-n-planks steve count5)

...
(:types
	...
	cobblestone planks grass_block - item
	cobblestone-block planks-block grass_block-block - destructible-block
)
(:predicates
...
(block-present ?b) (= (x ?b) -3) (= (y ?b) 6) (= (z ?b) 5)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 5) (= (z ?b) 5)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 4) (= (z ?b) 5)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 5) (= (z ?b) 4)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 5) (= (z ?b) 6)))
	 )
	:effect (and 
(goal-achieved ?ag))
)

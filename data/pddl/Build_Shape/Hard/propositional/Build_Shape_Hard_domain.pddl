...
(:types
	...
	dirt cobblestone_stairs fence gravel farmland leaves cobblestone ladder planks log wheat_seeds grass chest water oak_stairs torch oak_door grass_path grass_block flower glass - item
	dirt-block cobblestone_stairs-block fence-block gravel-block farmland-block leaves-block cobblestone-block ladder-block planks-block log-block wheat_seeds-block grass-block chest-block water-block oak_stairs-block torch-block oak_door-block grass_path-block grass_block-block flower-block glass-block - destructible-block
)
(:predicates

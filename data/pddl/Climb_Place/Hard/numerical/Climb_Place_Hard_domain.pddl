(define (domain Climb_Place_Hard)
...
(:types
	...
	grass_block oak_stairs cobblestone planks - item
	grass_block-block oak_stairs-block cobblestone-block planks-block - destructible-block
)
(:predicates
	(item-present ?i - item)

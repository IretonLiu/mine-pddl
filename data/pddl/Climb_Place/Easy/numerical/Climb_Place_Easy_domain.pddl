(define (domain Climb_Place_Easy)
...
(:types
	...
	planks oak_stairs grass_block cobblestone - item
	planks-block oak_stairs-block grass_block-block cobblestone-block - destructible-block
)
(:predicates

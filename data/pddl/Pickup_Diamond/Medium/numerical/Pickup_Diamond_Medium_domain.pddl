(define (domain Pickup_Diamond_Medium)
...
(:types
	...
	grass_block diamond planks cobblestone stone - item
	grass_block-block diamond-block planks-block cobblestone-block stone-block - destructible-block
)
(:predicates
	(item-present ?i - item)

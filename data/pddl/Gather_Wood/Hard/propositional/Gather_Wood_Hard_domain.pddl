...
(:types
	...
	flower gravel cobblestone_stairs leaves ladder log dirt planks grass_path glass cobblestone farmland torch wheat_seeds fence grass oak_door chest water grass_block - item
	flower-block gravel-block cobblestone_stairs-block leaves-block ladder-block log-block dirt-block planks-block grass_path-block glass-block cobblestone-block farmland-block torch-block wheat_seeds-block fence-block grass-block oak_door-block chest-block water-block grass_block-block - destructible-block
)
(:predicates

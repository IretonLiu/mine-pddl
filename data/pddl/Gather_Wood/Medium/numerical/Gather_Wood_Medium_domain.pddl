(define (domain Gather_Wood_Medium)
...
(:types
	...
	cobblestone grass_block stone log obsidian - item
	cobblestone-block grass_block-block stone-block log-block obsidian-block - destructible-block
)
(:predicates
	(item-present ?i - item)

(define (domain Build_Cross_Hard)
...
(:types
	...
	chest leaves ladder oak_door grass_block grass glass fence torch planks gravel farmland water grass_path flower dirt wheat_seeds cobblestone log cobblestone_stairs - item
	chest-block leaves-block ladder-block oak_door-block grass_block-block grass-block glass-block fence-block torch-block planks-block gravel-block farmland-block water-block grass_path-block flower-block dirt-block wheat_seeds-block cobblestone-block log-block cobblestone_stairs-block - destructible-block
)
(:predicates

(define (domain Build_Cross_Easy)
...
(:types
	...
	grass_block planks stone - item
	grass_block-block planks-block stone-block - destructible-block
)
(:predicates
...
(block-present ?b) (= (x ?b) 2) (= (y ?b) 6) (= (z ?b) 2)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) 2) (= (y ?b) 5) (= (z ?b) 2)))
	(exists (?b - planks-block) (and 

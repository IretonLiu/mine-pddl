...
(:types
	...
	ladder leaves planks wheat_seeds glass grass_path gravel water cobblestone chest grass_block dirt torch cobblestone_stairs fence oak_door flower log farmland grass - item
	ladder-block leaves-block planks-block wheat_seeds-block glass-block grass_path-block gravel-block water-block cobblestone-block chest-block grass_block-block dirt-block torch-block cobblestone_stairs-block fence-block oak_door-block flower-block log-block farmland-block grass-block - destructible-block
)
(:predicates

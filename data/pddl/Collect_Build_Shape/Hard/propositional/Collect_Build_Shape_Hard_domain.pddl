...
(:types
	...
	dirt chest stone leaves cobblestone fence flower gravel planks farmland oak_stairs grass_block log torch wheat_seeds water cobblestone_stairs ladder oak_door grass_path glass grass - item
	dirt-block chest-block stone-block leaves-block cobblestone-block fence-block flower-block gravel-block planks-block farmland-block oak_stairs-block grass_block-block log-block torch-block wheat_seeds-block water-block cobblestone_stairs-block ladder-block oak_door-block grass_path-block glass-block grass-block - destructible-block
)
(:predicates

...
(:types
	...
	stone_bricks planks oak_stairs stone grass_block cobblestone - item
	stone_bricks-block planks-block oak_stairs-block stone-block grass_block-block cobblestone-block - destructible-block
)
(:predicates
...
(block-present ?b) (= (x ?b) -5) (= (y ?b) 7) (= (z ?b) -5)))

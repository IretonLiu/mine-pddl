(define (domain Place_Wood_Medium)
...
(:types
	...
	stone cobblestone grass_block planks log - item
	stone-block cobblestone-block grass_block-block planks-block log-block - destructible-block
)
(:predicates
	(item-present ?i - item)

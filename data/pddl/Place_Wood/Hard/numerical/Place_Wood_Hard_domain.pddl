...
(:types
	...
	glass water oak_door farmland grass_block chest grass dirt cobblestone_stairs torch leaves planks flower gravel fence wheat_seeds cobblestone log grass_path ladder - item
	glass-block water-block oak_door-block farmland-block grass_block-block chest-block grass-block dirt-block cobblestone_stairs-block torch-block leaves-block planks-block flower-block gravel-block fence-block wheat_seeds-block cobblestone-block log-block grass_path-block ladder-block - destructible-block
)
(:predicates

...
(:types
	...
	fence planks glowstone stone grass_block cobblestone - item
	fence-block planks-block glowstone-block stone-block grass_block-block cobblestone-block - destructible-block
)
(:predicates
...
(block-present ?b) (= (x ?b) -3) (= (y ?b) 4) (= (z ?b) 3)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 4) (= (z ?b) 4)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -2) (= (y ?b) 4) (= (z ?b) 2)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -2) (= (y ?b) 4) (= (z ?b) 3)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -2) (= (y ?b) 4) (= (z ?b) 4)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 4) (= (z ?b) 2)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 4) (= (z ?b) 3)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 4) (= (z ?b) 4)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 7) (= (z ?b) 2)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 7) (= (z ?b) 3)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 7) (= (z ?b) 4)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) -2) (= (y ?b) 7) (= (z ?b) 2)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) -2) (= (y ?b) 7) (= (z ?b) 4)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 7) (= (z ?b) 2)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 7) (= (z ?b) 3)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 7) (= (z ?b) 4)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 5) (= (z ?b) 2)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 6) (= (z ?b) 2)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 5) (= (z ?b) 4)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -3) (= (y ?b) 6) (= (z ?b) 4)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 5) (= (z ?b) 2)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 6) (= (z ?b) 2)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 5) (= (z ?b) 4)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 6) (= (z ?b) 4)))
	(exists (?b - glowstone-block) (and 
(block-present ?b) (= (x ?b) -2) (= (y ?b) 7) (= (z ?b) 3)))
	 )
	:effect (and 
(goal-achieved ?ag))
)

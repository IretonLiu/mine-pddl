(define (domain Build_Well_Medium)
...
(:types
	...
	dirt cobblestone wool bricks grass_block planks glowstone log stone_bricks fence - item
	dirt-block cobblestone-block wool-block bricks-block grass_block-block planks-block glowstone-block log-block stone_bricks-block fence-block - destructible-block
)
(:predicates
...
(block-present ?b) (= (x ?b) -1) (= (y ?b) 4) (= (z ?b) 5)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 4) (= (z ?b) 6)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 4) (= (z ?b) 7)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) 0) (= (y ?b) 4) (= (z ?b) 5)))
	(exists (?b - cobblestone-block) (and 
(block-present ?b) (= (x ?b) 0) (= (y ?b) 4) (= (z ?b) 6)))
	(exists (?b - cobblestone-block) (and 
...
(block-present ?b) (= (x ?b) -1) (= (y ?b) 7) (= (z ?b) 5)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 7) (= (z ?b) 6)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 7) (= (z ?b) 7)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) 0) (= (y ?b) 7) (= (z ?b) 5)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) 0) (= (y ?b) 7) (= (z ?b) 7)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) 1) (= (y ?b) 7) (= (z ?b) 5)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) 1) (= (y ?b) 7) (= (z ?b) 6)))
...
(block-present ?b) (= (x ?b) -1) (= (y ?b) 5) (= (z ?b) 5)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 6) (= (z ?b) 5)))
	(exists (?b - fence-block) (and 
...
(block-present ?b) (= (x ?b) 0) (= (y ?b) 7) (= (z ?b) 6)))
	 )
	:effect (and 
(goal-achieved ?ag))
)

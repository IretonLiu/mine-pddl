...
(:types
	...
	log farmland torch flower grass_block grass_path water grass cobblestone chest glowstone cobblestone_stairs dirt fence wheat_seeds oak_door leaves planks gravel glass ladder - item
	log-block farmland-block torch-block flower-block grass_block-block grass_path-block water-block grass-block cobblestone-block chest-block glowstone-block cobblestone_stairs-block dirt-block fence-block wheat_seeds-block oak_door-block leaves-block planks-block gravel-block glass-block ladder-block - destructible-block
)
(:predicates

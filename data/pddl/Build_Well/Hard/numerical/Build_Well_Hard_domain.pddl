...
(:types
	...
	cobblestone_stairs grass_block planks glass gravel ladder water dirt leaves grass_path farmland oak_door log chest cobblestone flower glowstone torch wheat_seeds grass fence - item
	cobblestone_stairs-block grass_block-block planks-block glass-block gravel-block ladder-block water-block dirt-block leaves-block grass_path-block farmland-block oak_door-block log-block chest-block cobblestone-block flower-block glowstone-block torch-block wheat_seeds-block grass-block fence-block - destructible-block
)
(:predicates
...
(block-present ?b) (= (x ?b) 1) (= (y ?b) 4) (= (z ?b) 11)))
...
(block-present ?b) (= (x ?b) 1) (= (y ?b) 5) (= (z ?b) 11)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) 1) (= (y ?b) 6) (= (z ?b) 11)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 5) (= (z ?b) 11)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 6) (= (z ?b) 11)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) 1) (= (y ?b) 5) (= (z ?b) 13)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) 1) (= (y ?b) 6) (= (z ?b) 13)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 5) (= (z ?b) 13)))
	(exists (?b - fence-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 6) (= (z ?b) 13)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) 1) (= (y ?b) 7) (= (z ?b) 11)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) 0) (= (y ?b) 7) (= (z ?b) 11)))
	(exists (?b - planks-block) (and 
(block-present ?b) (= (x ?b) -1) (= (y ?b) 7) (= (z ?b) 11)))
	(exists (?b - planks-block) (and 

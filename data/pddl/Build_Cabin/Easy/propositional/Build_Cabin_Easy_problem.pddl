(define (problem Build_Cabin_Easy_problem)
	(:domain Build_Cabin_Easy)
(:objects
	steve - agent
	fence0 - fence
...
(:init
	...
	(agent-has-n-fence steve count64)

	(agent-has-n-glass steve count32)

	(agent-has-n-oak_stairs steve count1)

	(agent-has-n-glowstone steve count1)
	...
	(at-x fence0 position0)

	(at-y fence0 position4)

	(at-z fence0 position0)

	(not (item-present fence0))
	...
	(at-x oak_stairs0 position0)

	(at-y oak_stairs0 position4)

	(at-z oak_stairs0 position0)

	(not (item-present oak_stairs0))
	(at-x glowstone0 position0)

	(at-y glowstone0 position4)

	(at-z glowstone0 position0)

	(not (item-present glowstone0))
)
(:goal

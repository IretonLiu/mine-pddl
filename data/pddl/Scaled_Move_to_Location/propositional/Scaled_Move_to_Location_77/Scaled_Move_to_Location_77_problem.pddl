(define (problem Scaled_Move_to_Location_77_problem)
	(:domain Scaled_Move_to_Location_77)
(:objects
	steve - agent
...
(:init
	...
	(at-x grass_block-block76 position38)

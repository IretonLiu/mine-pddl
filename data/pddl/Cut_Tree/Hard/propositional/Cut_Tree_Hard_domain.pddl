...
(:types
	...
	grass_path cobblestone_stairs leaves grass_block water cobblestone flower glass chest dirt torch ladder grass gravel fence log wheat_seeds planks oak_door farmland - item
	grass_path-block cobblestone_stairs-block leaves-block grass_block-block water-block cobblestone-block flower-block glass-block chest-block dirt-block torch-block ladder-block grass-block gravel-block fence-block log-block wheat_seeds-block planks-block oak_door-block farmland-block - destructible-block
)
(:predicates

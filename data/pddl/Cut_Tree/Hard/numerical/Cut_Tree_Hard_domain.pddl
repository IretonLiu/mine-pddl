...
(:action checkgoal
	:parameters (?ag - agent)
	:precondition (and 
(agent-alive ?ag)  (exists (?b - air-block) (and 
(block-present ?b) (= (x ?b) 4) (= (y ?b) 4) (= (z ?b) -5)))
	(exists (?b - air-block) (and 
(block-present ?b) (= (x ?b) 4) (= (y ?b) 5) (= (z ?b) -5)))
	(exists (?b - air-block) (and 
(block-present ?b) (= (x ?b) 4) (= (y ?b) 6) (= (z ?b) -5)))
	(exists (?b - air-block) (and 
(block-present ?b) (= (x ?b) 4) (= (y ?b) 7) (= (z ?b) -5)))
	(exists (?b - air-block) (and 
(block-present ?b) (= (x ?b) 4) (= (y ?b) 8) (= (z ?b) -5)))
	(exists (?b - air-block) (and 
(block-present ?b) (= (x ?b) 4) (= (y ?b) 9) (= (z ?b) -5)))
	(exists (?b - air-block) (and 
(block-present ?b) (= (x ?b) 4) (= (y ?b) 10) (= (z ?b) -5)))
	(exists (?b - air-block) (and 
(block-present ?b) (= (x ?b) 4) (= (y ?b) 11) (= (z ?b) -5)))
	 (>= (agent-num-log ?ag) 8))
	:effect (and 
(goal-achieved ?ag))
)

(define (domain Gather_Multiple_Wood_Hard)
...
(:types
	...
	oak_door dirt chest grass_block planks gravel leaves flower ladder fence glass water cobblestone_stairs wheat_seeds cobblestone grass farmland torch grass_path log - item
	oak_door-block dirt-block chest-block grass_block-block planks-block gravel-block leaves-block flower-block ladder-block fence-block glass-block water-block cobblestone_stairs-block wheat_seeds-block cobblestone-block grass-block farmland-block torch-block grass_path-block log-block - destructible-block
)
(:predicates

...
(:types
	...
	torch wheat_seeds dirt log fence oak_door chest planks leaves grass ladder grass_path gravel cobblestone flower glass water farmland grass_block cobblestone_stairs - item
	torch-block wheat_seeds-block dirt-block log-block fence-block oak_door-block chest-block planks-block leaves-block grass-block ladder-block grass_path-block gravel-block cobblestone-block flower-block glass-block water-block farmland-block grass_block-block cobblestone_stairs-block - destructible-block
)
(:predicates

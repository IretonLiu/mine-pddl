...
(:types
	...
	flower cobblestone chest glass ladder torch grass_block wheat_seeds cobblestone_stairs planks gravel oak_door water log farmland leaves dirt grass fence - item
	flower-block cobblestone-block chest-block glass-block ladder-block torch-block grass_block-block wheat_seeds-block cobblestone_stairs-block planks-block gravel-block oak_door-block water-block log-block farmland-block leaves-block dirt-block grass-block fence-block - destructible-block
)
(:predicates

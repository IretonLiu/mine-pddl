(define (problem Pickup_and_Place_Easy_problem)
	(:domain Pickup_and_Place_Easy)
(:objects
	steve - agent
	planks0 - planks
...
(:init
	...
	(is-any-block-at-position position-1 position4 position4)

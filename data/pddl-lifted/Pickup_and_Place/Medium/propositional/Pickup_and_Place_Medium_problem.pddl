(define (problem Pickup_and_Place_Medium_problem)
	(:domain Pickup_and_Place_Medium)
(:objects
	steve - agent
	...
	stone_bricks0 stone_bricks1 stone_bricks2 stone_bricks3 - stone_bricks
	stone_bricks-block0 stone_bricks-block1 stone_bricks-block2 stone_bricks-block3 - stone_bricks-block
...
(:init
	...
	(at-x dirt-block0 position-1)

	(at-y dirt-block0 position3)

	(at-z dirt-block0 position-2)

	(block-present dirt-block0)
	(at-x stone-block0 position-1)

	(at-y stone-block0 position4)

	(at-z stone-block0 position-2)

	(block-present stone-block0)
	(at-x stone-block1 position0)

	(at-y stone-block1 position4)

	(at-z stone-block1 position-2)

	(block-present stone-block1)
	(at-x stone-block2 position1)

	(at-y stone-block2 position4)

	(at-z stone-block2 position3)

	(block-present stone-block2)
	(at-x stone-block3 position1)

	(at-y stone-block3 position5)

	(at-z stone-block3 position-4)

	(block-present stone-block3)
	(at-x stone-block4 position3)

	(at-y stone-block4 position4)

	(at-z stone-block4 position-4)
	...
	(at-z stone_bricks-block0 position2)

	(block-present stone_bricks-block0)
	(at-x stone_bricks-block1 position-1)

	(at-y stone_bricks-block1 position4)

	(at-z stone_bricks-block1 position3)

	(block-present stone_bricks-block1)
	(at-x stone_bricks-block2 position0)

	(at-y stone_bricks-block2 position5)

	(at-z stone_bricks-block2 position4)

	(block-present stone_bricks-block2)
	(at-x stone_bricks-block3 position3)

	(at-y stone_bricks-block3 position5)

	(at-z stone_bricks-block3 position-5)

	(block-present stone_bricks-block3)
	(at-x cobblestone-block0 position0)

	(at-y cobblestone-block0 position4)

	(at-z cobblestone-block0 position4)

	(block-present cobblestone-block0)
	(at-x cobblestone-block1 position1)
	...
	(at-x cobblestone-block2 position2)
	...
	(at-x cobblestone-block3 position2)

	(at-y cobblestone-block3 position6)

	(at-z cobblestone-block3 position-4)

	(block-present cobblestone-block3)
	(at-x cobblestone-block4 position3)

	(at-y cobblestone-block4 position6)

	(at-z cobblestone-block4 position-5)

	(block-present cobblestone-block4)
	(at-x cobblestone-block5 position4)

	(at-y cobblestone-block5 position4)

	(at-z cobblestone-block5 position-5)

	(block-present cobblestone-block5)
	(at-x planks-block0 position2)

	(at-y planks-block0 position5)

	(at-z planks-block0 position-4)
	...
	(is-any-block-at-position position-1 position4 position-2)

	(is-any-block-at-position position-1 position4 position2)
	...
	(is-any-block-at-position position0 position4 position4)

	(is-any-block-at-position position0 position5 position4)
	...
	(is-any-block-at-position position1 position5 position-4)
	...
	(is-any-block-at-position position2 position6 position-4)
	...
	(is-any-block-at-position position3 position4 position-4)

	(is-any-block-at-position position3 position5 position-5)

	(is-any-block-at-position position3 position6 position-5)
	...
	(is-any-block-at-position position4 position4 position-5)

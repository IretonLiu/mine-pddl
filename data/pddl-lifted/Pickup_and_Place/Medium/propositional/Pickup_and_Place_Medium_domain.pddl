...
(:types
	...
	cobblestone dirt stone_bricks stone planks grass_block - item
	cobblestone-block dirt-block stone_bricks-block stone-block planks-block grass_block-block - destructible-block
)
(:predicates

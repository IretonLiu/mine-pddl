...
(:init
	...
	(agent-alive steve)
	(agent-has-n-cobblestone steve count6)

	(agent-has-n-planks steve count2)

	(agent-has-n-glass steve count1)
	...
	(at-z grass_block-block158 position2)
	...
	(at-z grass_block-block159 position3)
	...
	(at-z grass_block-block160 position4)
	...
	(at-z grass_block-block161 position5)
	...
	(at-z grass_block-block162 position6)
	...
	(at-z grass_block-block163 position7)
	...
	(at-z grass_block-block164 position8)
	...
	(at-z grass_block-block165 position9)
	...
	(at-z grass_block-block166 position10)

	(block-present grass_block-block166)
	(at-x grass_block-block167 position-2)

	(at-y grass_block-block167 position3)

	(at-z grass_block-block167 position-10)
	...
	(at-z grass_block-block168 position-9)
	...
	(at-z grass_block-block169 position-8)
	...
	(at-z dirt-block0 position1)

	(block-present dirt-block0)
	(at-x stone-block0 position-3)

	(at-y stone-block0 position4)

	(at-z stone-block0 position0)

	(block-present stone-block0)
	(at-x stone-block1 position-3)

	(at-y stone-block1 position4)

	(at-z stone-block1 position1)

	(block-present stone-block1)
	(at-x stone-block2 position-2)

	(at-y stone-block2 position4)

	(at-z stone-block2 position1)

	(block-present stone-block2)
	(at-x stone-block3 position2)

	(at-y stone-block3 position4)

	(at-z stone-block3 position0)

	(block-present stone-block3)
	(at-x stone_bricks-block0 position-1)
	...
	(at-x stone_bricks-block1 position0)
	...
	(at-x stone_bricks-block2 position1)

	(at-y stone_bricks-block2 position4)

	(at-z stone_bricks-block2 position-3)

	(block-present stone_bricks-block2)
	(at-x planks-block0 position1)

	(at-y planks-block0 position4)

	(at-z planks-block0 position4)

	(block-present planks-block0)
	(at-x planks-block1 position1)
	...
	(at-x planks-block2 position1)

	(at-y planks-block2 position5)

	(at-z planks-block2 position4)
	...
	(at-z planks-block3 position4)

	(block-present planks-block3)
	(at-x cobblestone-block0 position2)
	...
	(at-x glass0 position0)

	(at-y glass0 position4)

	(at-z glass0 position0)
	...
	(is-any-block-at-position position-3 position4 position1)
	...
	(is-any-block-at-position position-2 position4 position1)
	...
	(is-any-block-at-position position-1 position4 position-3)
	...
	(is-any-block-at-position position0 position4 position-3)
	...
	(is-any-block-at-position position1 position4 position4)

	(is-any-block-at-position position1 position4 position5)

	(is-any-block-at-position position1 position5 position4)
	...
	(is-any-block-at-position position2 position4 position0)

	(is-any-block-at-position position2 position4 position1)

	(is-any-block-at-position position2 position4 position4)

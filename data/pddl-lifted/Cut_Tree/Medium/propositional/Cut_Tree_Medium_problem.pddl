...
(:init
	...
	(is-any-block-at-position position-3 position7 position4)

	(is-any-block-at-position position-3 position7 position5)

	(is-any-block-at-position position-3 position7 position6)

	(is-any-block-at-position position-3 position9 position4)

	(is-any-block-at-position position-3 position9 position5)

	(is-any-block-at-position position-3 position9 position6)
	...
	(is-any-block-at-position position-2 position7 position7)

	(is-any-block-at-position position-2 position8 position5)

	(is-any-block-at-position position-2 position9 position3)

	(is-any-block-at-position position-2 position9 position4)

	(is-any-block-at-position position-2 position9 position5)

	(is-any-block-at-position position-2 position9 position6)

	(is-any-block-at-position position-2 position9 position7)

	(is-any-block-at-position position-2 position10 position4)

	(is-any-block-at-position position-2 position10 position5)

	(is-any-block-at-position position-2 position10 position6)

	(is-any-block-at-position position-2 position11 position5)

	(is-any-block-at-position position-2 position13 position5)
	...
	(is-any-block-at-position position-1 position4 position5)

	(is-any-block-at-position position-1 position5 position5)
	...
	(is-any-block-at-position position-1 position7 position7)

	(is-any-block-at-position position-1 position8 position4)

	(is-any-block-at-position position-1 position8 position5)

	(is-any-block-at-position position-1 position8 position6)

	(is-any-block-at-position position-1 position9 position3)

	(is-any-block-at-position position-1 position9 position4)

	(is-any-block-at-position position-1 position9 position5)

	(is-any-block-at-position position-1 position9 position6)

	(is-any-block-at-position position-1 position9 position7)

	(is-any-block-at-position position-1 position10 position4)

	(is-any-block-at-position position-1 position10 position5)

	(is-any-block-at-position position-1 position10 position6)

	(is-any-block-at-position position-1 position11 position4)

	(is-any-block-at-position position-1 position11 position5)

	(is-any-block-at-position position-1 position11 position6)

	(is-any-block-at-position position-1 position12 position5)

	(is-any-block-at-position position-1 position13 position4)

	(is-any-block-at-position position-1 position13 position5)

	(is-any-block-at-position position-1 position13 position6)

	(is-any-block-at-position position-1 position14 position5)
	...
	(is-any-block-at-position position0 position7 position7)
	...
	(is-any-block-at-position position0 position9 position6)

	(is-any-block-at-position position0 position9 position7)

	(is-any-block-at-position position0 position10 position4)

	(is-any-block-at-position position0 position10 position5)

	(is-any-block-at-position position0 position10 position6)

	(is-any-block-at-position position0 position11 position5)

	(is-any-block-at-position position0 position13 position5)
	...
	(is-any-block-at-position position1 position9 position5)

	(is-any-block-at-position position1 position9 position6)

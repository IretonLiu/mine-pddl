(define (problem Cut_Tree_Easy_problem)
	(:domain Cut_Tree_Easy)
(:objects
	steve - agent
	log0 log1 log2 log3 log4 - log
	log-block0 log-block1 log-block2 log-block3 log-block4 - log-block
	stone0 - stone
...
(:init
	...
	(at-x leaves-block0 position-2)

	(at-y leaves-block0 position6)

	(at-z leaves-block0 position2)

	(block-present leaves-block0)
	(at-x leaves-block1 position-2)

	(at-y leaves-block1 position6)

	(at-z leaves-block1 position3)

	(block-present leaves-block1)
	(at-x leaves-block2 position-2)

	(at-y leaves-block2 position6)

	(at-z leaves-block2 position4)

	(block-present leaves-block2)
	(at-x leaves-block3 position-2)

	(at-y leaves-block3 position6)

	(at-z leaves-block3 position5)

	(block-present leaves-block3)
	(at-x leaves-block4 position-2)

	(at-y leaves-block4 position6)

	(at-z leaves-block4 position6)

	(block-present leaves-block4)
	(at-x leaves-block5 position-2)

	(at-y leaves-block5 position7)

	(at-z leaves-block5 position3)

	(block-present leaves-block5)
	(at-x leaves-block6 position-2)

	(at-y leaves-block6 position7)

	(at-z leaves-block6 position4)
	...
	(at-z leaves-block8 position6)

	(block-present leaves-block8)
	(at-x leaves-block9 position-1)

	(at-y leaves-block9 position6)

	(at-z leaves-block9 position2)

	(block-present leaves-block9)
	(at-x leaves-block10 position-1)

	(at-y leaves-block10 position6)

	(at-z leaves-block10 position3)

	(block-present leaves-block10)
	(at-x leaves-block11 position-1)

	(at-y leaves-block11 position6)

	(at-z leaves-block11 position4)

	(block-present leaves-block11)
	(at-x leaves-block12 position-1)

	(at-y leaves-block12 position6)

	(at-z leaves-block12 position5)

	(block-present leaves-block12)
	(at-x leaves-block13 position-1)

	(at-y leaves-block13 position6)

	(at-z leaves-block13 position6)

	(block-present leaves-block13)
	(at-x leaves-block14 position-1)

	(at-y leaves-block14 position7)

	(at-z leaves-block14 position2)

	(block-present leaves-block14)
	(at-x leaves-block15 position-1)

	(at-y leaves-block15 position7)

	(at-z leaves-block15 position3)

	(block-present leaves-block15)
	(at-x leaves-block16 position-1)

	(at-y leaves-block16 position7)

	(at-z leaves-block16 position4)

	(block-present leaves-block16)
	(at-x leaves-block17 position-1)

	(at-y leaves-block17 position7)

	(at-z leaves-block17 position5)

	(block-present leaves-block17)
	(at-x leaves-block18 position-1)

	(at-y leaves-block18 position7)

	(at-z leaves-block18 position6)

	(block-present leaves-block18)
	(at-x leaves-block19 position-1)

	(at-y leaves-block19 position8)

	(at-z leaves-block19 position4)

	(block-present leaves-block19)
	(at-x leaves-block20 position-1)

	(at-y leaves-block20 position8)

	(at-z leaves-block20 position5)

	(block-present leaves-block20)
	(at-x leaves-block21 position-1)

	(at-y leaves-block21 position9)

	(at-z leaves-block21 position4)

	(block-present leaves-block21)
	(at-x leaves-block22 position0)

	(at-y leaves-block22 position6)

	(at-z leaves-block22 position2)

	(block-present leaves-block22)
	(at-x leaves-block23 position0)

	(at-y leaves-block23 position6)

	(at-z leaves-block23 position3)

	(block-present leaves-block23)
	(at-x leaves-block24 position0)

	(at-y leaves-block24 position6)

	(at-z leaves-block24 position5)

	(block-present leaves-block24)
	(at-x leaves-block25 position0)

	(at-y leaves-block25 position6)

	(at-z leaves-block25 position6)

	(block-present leaves-block25)
	(at-x leaves-block26 position0)

	(at-y leaves-block26 position7)

	(at-z leaves-block26 position2)

	(block-present leaves-block26)
	(at-x leaves-block27 position0)

	(at-y leaves-block27 position7)

	(at-z leaves-block27 position3)

	(block-present leaves-block27)
	(at-x leaves-block28 position0)

	(at-y leaves-block28 position7)

	(at-z leaves-block28 position5)

	(block-present leaves-block28)
	(at-x leaves-block29 position0)

	(at-y leaves-block29 position7)

	(at-z leaves-block29 position6)

	(block-present leaves-block29)
	(at-x leaves-block30 position0)

	(at-y leaves-block30 position8)

	(at-z leaves-block30 position3)

	(block-present leaves-block30)
	(at-x leaves-block31 position0)

	(at-y leaves-block31 position8)

	(at-z leaves-block31 position5)

	(block-present leaves-block31)
	(at-x leaves-block32 position0)

	(at-y leaves-block32 position9)

	(at-z leaves-block32 position3)

	(block-present leaves-block32)
	(at-x leaves-block33 position0)

	(at-y leaves-block33 position9)

	(at-z leaves-block33 position4)

	(block-present leaves-block33)
	(at-x leaves-block34 position0)

	(at-y leaves-block34 position9)

	(at-z leaves-block34 position5)

	(block-present leaves-block34)
	(at-x leaves-block35 position1)

	(at-y leaves-block35 position6)

	(at-z leaves-block35 position2)

	(block-present leaves-block35)
	(at-x leaves-block36 position1)

	(at-y leaves-block36 position6)

	(at-z leaves-block36 position3)

	(block-present leaves-block36)
	(at-x leaves-block37 position1)

	(at-y leaves-block37 position6)

	(at-z leaves-block37 position4)

	(block-present leaves-block37)
	(at-x leaves-block38 position1)

	(at-y leaves-block38 position6)

	(at-z leaves-block38 position5)

	(block-present leaves-block38)
	(at-x leaves-block39 position1)

	(at-y leaves-block39 position6)

	(at-z leaves-block39 position6)

	(block-present leaves-block39)
	(at-x leaves-block40 position1)

	(at-y leaves-block40 position7)

	(at-z leaves-block40 position2)

	(block-present leaves-block40)
	(at-x leaves-block41 position1)

	(at-y leaves-block41 position7)

	(at-z leaves-block41 position3)

	(block-present leaves-block41)
	(at-x leaves-block42 position1)

	(at-y leaves-block42 position7)

	(at-z leaves-block42 position4)

	(block-present leaves-block42)
	(at-x leaves-block43 position1)

	(at-y leaves-block43 position7)

	(at-z leaves-block43 position5)

	(block-present leaves-block43)
	(at-x leaves-block44 position1)

	(at-y leaves-block44 position7)

	(at-z leaves-block44 position6)

	(block-present leaves-block44)
	(at-x leaves-block45 position1)

	(at-y leaves-block45 position8)

	(at-z leaves-block45 position4)

	(block-present leaves-block45)
	(at-x leaves-block46 position1)

	(at-y leaves-block46 position9)

	(at-z leaves-block46 position4)

	(block-present leaves-block46)
	(at-x leaves-block47 position2)

	(at-y leaves-block47 position6)

	(at-z leaves-block47 position2)

	(block-present leaves-block47)
	(at-x leaves-block48 position2)

	(at-y leaves-block48 position6)

	(at-z leaves-block48 position3)

	(block-present leaves-block48)
	(at-x leaves-block49 position2)

	(at-y leaves-block49 position6)

	(at-z leaves-block49 position4)

	(block-present leaves-block49)
	(at-x leaves-block50 position2)

	(at-y leaves-block50 position6)

	(at-z leaves-block50 position5)

	(block-present leaves-block50)
	(at-x leaves-block51 position2)

	(at-y leaves-block51 position6)

	(at-z leaves-block51 position6)

	(block-present leaves-block51)
	(at-x leaves-block52 position2)

	(at-y leaves-block52 position7)

	(at-z leaves-block52 position3)

	(block-present leaves-block52)
	(at-x leaves-block53 position2)

	(at-y leaves-block53 position7)

	(at-z leaves-block53 position4)

	(block-present leaves-block53)
	(at-x leaves-block54 position2)

	(at-y leaves-block54 position7)

	(at-z leaves-block54 position5)

	(block-present leaves-block54)
	(at-x log-block0 position0)
	...
	(at-x log-block2 position0)

	(at-y log-block2 position6)

	(at-z log-block2 position4)
	...
	(at-z log-block3 position4)

	(block-present log-block3)
	(at-x log-block4 position0)

	(at-y log-block4 position8)

	(at-z log-block4 position4)
	...
	(is-any-block-at-position position-2 position6 position2)

	(is-any-block-at-position position-2 position6 position3)

	(is-any-block-at-position position-2 position6 position4)

	(is-any-block-at-position position-2 position6 position5)

	(is-any-block-at-position position-2 position6 position6)

	(is-any-block-at-position position-2 position7 position3)

	(is-any-block-at-position position-2 position7 position4)

	(is-any-block-at-position position-2 position7 position5)

	(is-any-block-at-position position-2 position7 position6)
	...
	(is-any-block-at-position position-1 position6 position2)

	(is-any-block-at-position position-1 position6 position3)

	(is-any-block-at-position position-1 position6 position4)

	(is-any-block-at-position position-1 position6 position5)

	(is-any-block-at-position position-1 position6 position6)

	(is-any-block-at-position position-1 position7 position2)

	(is-any-block-at-position position-1 position7 position3)

	(is-any-block-at-position position-1 position7 position4)

	(is-any-block-at-position position-1 position7 position5)

	(is-any-block-at-position position-1 position7 position6)

	(is-any-block-at-position position-1 position8 position4)

	(is-any-block-at-position position-1 position8 position5)

	(is-any-block-at-position position-1 position9 position4)
	...
	(is-any-block-at-position position0 position6 position2)

	(is-any-block-at-position position0 position6 position3)

	(is-any-block-at-position position0 position6 position4)

	(is-any-block-at-position position0 position6 position5)

	(is-any-block-at-position position0 position6 position6)

	(is-any-block-at-position position0 position7 position2)

	(is-any-block-at-position position0 position7 position3)

	(is-any-block-at-position position0 position7 position4)

	(is-any-block-at-position position0 position7 position5)

	(is-any-block-at-position position0 position7 position6)

	(is-any-block-at-position position0 position8 position3)

	(is-any-block-at-position position0 position8 position4)

	(is-any-block-at-position position0 position8 position5)

	(is-any-block-at-position position0 position9 position3)

	(is-any-block-at-position position0 position9 position4)

	(is-any-block-at-position position0 position9 position5)
	...
	(is-any-block-at-position position1 position6 position2)

	(is-any-block-at-position position1 position6 position3)

	(is-any-block-at-position position1 position6 position4)

	(is-any-block-at-position position1 position6 position5)

	(is-any-block-at-position position1 position6 position6)

	(is-any-block-at-position position1 position7 position2)

	(is-any-block-at-position position1 position7 position3)

	(is-any-block-at-position position1 position7 position4)

	(is-any-block-at-position position1 position7 position5)

	(is-any-block-at-position position1 position7 position6)

	(is-any-block-at-position position1 position8 position4)

	(is-any-block-at-position position1 position9 position4)
	...
	(is-any-block-at-position position2 position6 position2)

	(is-any-block-at-position position2 position6 position3)

	(is-any-block-at-position position2 position6 position4)

	(is-any-block-at-position position2 position6 position5)

	(is-any-block-at-position position2 position6 position6)

	(is-any-block-at-position position2 position7 position3)

	(is-any-block-at-position position2 position7 position4)

	(is-any-block-at-position position2 position7 position5)

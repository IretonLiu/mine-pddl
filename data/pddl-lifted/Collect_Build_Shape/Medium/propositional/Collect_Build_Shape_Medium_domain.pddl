...
(:types
	...
	grass_block cobblestone stone stone_bricks oak_stairs planks - item
	grass_block-block cobblestone-block stone-block stone_bricks-block oak_stairs-block planks-block - destructible-block
)
(:predicates
...
(:action checkgoal
	:parameters (?ag - agent ?b1 - block ?b2 - block ?b3 - block ?b4 - block ?b5 - block ?b6 - block ?b7 - block ?b8 - block ?b9 - block ?b10 - block ?b11 - block)
	:precondition (and 
(agent-alive ?ag)
 (and 
(block-present ?b1)

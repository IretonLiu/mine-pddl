(define (problem Collect_Build_Shape_Medium_problem)
	(:domain Collect_Build_Shape_Medium)
(:objects
	steve - agent
	stone0 - stone
	...
	planks0 planks1 planks2 - planks
	planks-block0 planks-block1 planks-block2 - planks-block
...
(:init
	...
	(at-x stone_bricks-block0 position-8)

	(at-y stone_bricks-block0 position4)

	(at-z stone_bricks-block0 position0)

	(block-present stone_bricks-block0)
	(at-x stone_bricks-block1 position-5)
	...
	(at-z stone_bricks-block2 position-8)

	(block-present stone_bricks-block2)
	(at-x stone_bricks-block3 position4)

	(at-y stone_bricks-block3 position4)

	(at-z stone_bricks-block3 position-3)
	...
	(at-z planks-block1 position4)

	(block-present planks-block1)
	(at-x planks-block2 position4)
	...
	(at-z cobblestone-block1 position-8)
	...
	(at-x oak_stairs-block0 position3)

	(at-y oak_stairs-block0 position4)

	(at-z oak_stairs-block0 position-4)
	...
	(is-any-block-at-position position-8 position4 position0)
	...
	(is-any-block-at-position position-5 position4 position-3)
	...
	(is-any-block-at-position position-2 position4 position4)
	...
	(is-any-block-at-position position1 position4 position-8)

	(is-any-block-at-position position1 position5 position-8)
	...
	(is-any-block-at-position position4 position4 position1)

	(is-any-block-at-position position4 position5 position1)

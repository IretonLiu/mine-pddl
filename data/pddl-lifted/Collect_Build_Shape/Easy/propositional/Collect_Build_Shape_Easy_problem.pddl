(define (problem Collect_Build_Shape_Easy_problem)
	(:domain Collect_Build_Shape_Easy)
(:objects
	steve - agent
	stone0 - stone
...
(:init
	...
	(at-x planks-block1 position-1)

	(at-y planks-block1 position4)

	(at-z planks-block1 position-1)
	...
	(is-any-block-at-position position-1 position4 position-1)
	...
	(is-any-block-at-position position2 position4 position2)

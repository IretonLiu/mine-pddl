...
(:types
	...
	ladder grass_block chest fence water oak_stairs cobblestone grass oak_door dirt farmland flower glass leaves stone log planks wheat_seeds gravel torch cobblestone_stairs - item
	ladder-block grass_block-block chest-block fence-block water-block oak_stairs-block cobblestone-block grass-block oak_door-block dirt-block farmland-block flower-block glass-block leaves-block stone-block log-block planks-block wheat_seeds-block gravel-block torch-block cobblestone_stairs-block - destructible-block
)
(:predicates
...
(:action place-oak_stairs-north
	:parameters (?ag - agent ?b - oak_stairs-block ?x - position ?y - position ?y_down - position ?z - position ?z_front - position ?n_start - count ?n_end - count ?b1 - block)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y)
...
(:action move_and_pickup-oak_stairs-north
	:parameters (?ag - agent ?i - oak_stairs ?x - position ?y_up - position ?y_down - position ?y_2_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count ?b1 - block)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action jumpup_and_pickup-oak_stairs-north
	:parameters (?ag - agent ?i - oak_stairs ?x - position ?y_up - position ?y_up_up - position ?y_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count ?b1 - block)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action jumpdown_and_pickup-oak_stairs-north
	:parameters (?ag - agent ?i - oak_stairs ?x - position ?y_up - position ?y_down - position ?y_2_down - position ?y_3_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count ?b1 - block)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action place-oak_stairs-east
	:parameters (?ag - agent ?b - oak_stairs-block ?x - position ?x_front - position ?y - position ?y_down - position ?z - position ?n_start - count ?n_end - count ?b1 - block)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y)
...
(:action move_and_pickup-oak_stairs-east
	:parameters (?ag - agent ?i - oak_stairs ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_down - position ?y_2_down - position ?n_start - count ?n_end - count ?b1 - block)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
...
(:action jumpup_and_pickup-oak_stairs-east
	:parameters (?ag - agent ?i - oak_stairs ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_up_up - position ?y_down - position ?n_start - count ?n_end - count ?b1 - block)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
...
(:action jumpdown_and_pickup-oak_stairs-east
	:parameters (?ag - agent ?i - oak_stairs ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_down - position ?y_2_down - position ?y_3_down - position ?n_start - count ?n_end - count ?b1 - block)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
...
(:action checkgoal
	:parameters (?ag - agent ?b1 - block ?b2 - block ?b3 - block ?b4 - block ?b5 - block ?b6 - block ?b7 - block ?b8 - block ?b9 - block ?b10 - block ?b11 - block ?b12 - block ?b13 - block ?b14 - block ?b15 - block ?b16 - block ?b17 - block ?b18 - block ?b19 - block ?b20 - block ?b21 - block ?b22 - block ?b23 - block ?b24 - block ?b25 - block ?b26 - block ?b27 - block)
	:precondition (and 
(agent-alive ?ag)
 (and 
(block-present ?b1)

(define (problem Build_Cross_Easy_problem)
	(:domain Build_Cross_Easy)
(:objects
	steve - agent
	...
	stone0 - stone
	stone-block0 stone-block1 stone-block2 stone-block3 stone-block4 stone-block5 stone-block6 stone-block7 stone-block8 stone-block9 stone-block10 - stone-block
)
(:init
	...
	(agent-alive steve)
	(agent-has-n-stone steve count10)
	...
	(at-z planks-block2 position0)

	(block-present planks-block2)
	(at-x planks-block3 position-1)

	(at-y planks-block3 position4)

	(at-z planks-block3 position-3)

	(block-present planks-block3)
	(at-x planks-block4 position1)

	(at-y planks-block4 position4)

	(at-z planks-block4 position-2)
	...
	(is-any-block-at-position position-2 position5 position0)

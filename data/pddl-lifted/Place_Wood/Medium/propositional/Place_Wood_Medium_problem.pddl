(define (problem Place_Wood_Medium_problem)
	(:domain Place_Wood_Medium)
(:objects
	steve - agent
	planks0 - planks
	planks-block0 planks-block1 - planks-block
	stone0 stone1 stone2 stone3 stone4 stone5 - stone
	stone-block0 stone-block1 stone-block2 stone-block3 stone-block4 stone-block5 - stone-block
	log0 - log
	...
	dirt0 dirt1 - dirt
	dirt-block0 dirt-block1 - dirt-block
)
(:init
	...
	(at-x cobblestone-block0 position-1)
	...
	(at-z cobblestone-block1 position2)

	(block-present cobblestone-block1)
	(at-x cobblestone-block2 position-1)

	(at-y cobblestone-block2 position5)

	(at-z cobblestone-block2 position1)

	(block-present cobblestone-block2)
	(at-x cobblestone-block3 position0)

	(at-y cobblestone-block3 position4)

	(at-z cobblestone-block3 position-3)
	...
	(at-z cobblestone-block4 position1)
	...
	(at-z cobblestone-block5 position-6)
	...
	(at-x dirt-block1 position3)

	(at-y dirt-block1 position3)

	(at-z dirt-block1 position-6)

	(block-present dirt-block1)
	(at-x stone-block0 position0)
	...
	(at-x stone-block1 position1)

	(at-y stone-block1 position4)

	(at-z stone-block1 position-3)
	...
	(at-z stone-block2 position-2)

	(block-present stone-block2)
	(at-x stone-block3 position3)

	(at-y stone-block3 position4)

	(at-z stone-block3 position-6)

	(block-present stone-block3)
	(at-x stone-block4 position4)

	(at-y stone-block4 position4)

	(at-z stone-block4 position-6)

	(block-present stone-block4)
	(at-x stone-block5 position4)

	(at-y stone-block5 position4)

	(at-z stone-block5 position-5)

	(block-present stone-block5)
	(at-x log-block0 position5)

	(at-y log-block0 position4)

	(at-z log-block0 position-6)
	...
	(is-any-block-at-position position-1 position4 position1)

	(is-any-block-at-position position-1 position4 position2)

	(is-any-block-at-position position-1 position5 position1)
	...
	(is-any-block-at-position position1 position4 position-2)

	(is-any-block-at-position position1 position4 position1)
	...
	(is-any-block-at-position position3 position4 position-6)
	...
	(is-any-block-at-position position4 position4 position-6)

	(is-any-block-at-position position4 position4 position-5)

	(is-any-block-at-position position4 position5 position-6)
	...
	(is-any-block-at-position position5 position4 position-6)

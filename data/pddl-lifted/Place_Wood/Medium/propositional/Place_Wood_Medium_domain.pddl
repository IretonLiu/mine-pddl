...
(:types
	...
	planks log grass_block dirt cobblestone stone - item
	planks-block log-block grass_block-block dirt-block cobblestone-block stone-block - destructible-block
)
(:predicates
	(item-present ?i - item)

...
(:types
	...
	grass gravel planks grass_block leaves water oak_door log torch chest cobblestone_stairs glass flower cobblestone ladder fence dirt farmland wheat_seeds - item
	grass-block gravel-block planks-block grass_block-block leaves-block water-block oak_door-block log-block torch-block chest-block cobblestone_stairs-block glass-block flower-block cobblestone-block ladder-block fence-block dirt-block farmland-block wheat_seeds-block - destructible-block
)
(:predicates

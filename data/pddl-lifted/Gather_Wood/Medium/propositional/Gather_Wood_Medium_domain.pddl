...
(:types
	...
	dirt stone obsidian grass_block cobblestone log - item
	dirt-block stone-block obsidian-block grass_block-block cobblestone-block log-block - destructible-block
)
(:predicates
	(item-present ?i - item)

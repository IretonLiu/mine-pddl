...
(:types
	...
	water grass_block oak_door cobblestone_stairs dirt log glass flower grass leaves fence farmland chest wheat_seeds torch ladder cobblestone gravel planks - item
	water-block grass_block-block oak_door-block cobblestone_stairs-block dirt-block log-block glass-block flower-block grass-block leaves-block fence-block farmland-block chest-block wheat_seeds-block torch-block ladder-block cobblestone-block gravel-block planks-block - destructible-block
)
(:predicates

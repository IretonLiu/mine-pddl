(define (problem Gather_Multiple_Wood_Medium_problem)
	(:domain Gather_Multiple_Wood_Medium)
(:objects
	steve - agent
...
(:init
	...
	(at-x stone_bricks-block2 position3)

	(at-y stone_bricks-block2 position5)

	(at-z stone_bricks-block2 position-5)
	...
	(at-x log-block2 position2)

	(at-y log-block2 position5)

	(at-z log-block2 position-4)

	(block-present log-block2)
	(at-x sand-block0 position1)

	(at-y sand-block0 position4)

	(at-z sand-block0 position4)

	(block-present sand-block0)

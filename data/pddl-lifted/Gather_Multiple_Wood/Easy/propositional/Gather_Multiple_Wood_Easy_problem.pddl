(define (problem Gather_Multiple_Wood_Easy_problem)
	(:domain Gather_Multiple_Wood_Easy)
(:objects
	steve - agent
	log0 log1 log2 - log
...
(:init
	...
	(at-z log-block1 position1)

	(block-present log-block1)
	(at-x log-block2 position1)

	(at-y log-block2 position4)

	(at-z log-block2 position-2)

...
(:types
	...
	fence glass dirt cobblestone farmland water oak_door chest flower wheat_seeds log grass ladder grass_block torch cobblestone_stairs leaves planks gravel - item
	fence-block glass-block dirt-block cobblestone-block farmland-block water-block oak_door-block chest-block flower-block wheat_seeds-block log-block grass-block ladder-block grass_block-block torch-block cobblestone_stairs-block leaves-block planks-block gravel-block - destructible-block
)
(:predicates

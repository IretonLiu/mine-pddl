(define (problem Pickup_Diamond_Easy_problem)
	(:domain Pickup_Diamond_Easy)
(:objects
	steve - agent
	diamond0 - diamond
	diamond-block0 - diamond-block
...
(:init
	...
	(at-x diamond0 position-4)

	(at-y diamond0 position4)

	(at-z diamond0 position2)
	...
	(is-any-item-at-position position-4 position4 position2)

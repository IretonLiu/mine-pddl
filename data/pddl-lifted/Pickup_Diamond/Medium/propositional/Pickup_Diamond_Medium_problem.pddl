(define (problem Pickup_Diamond_Medium_problem)
	(:domain Pickup_Diamond_Medium)
(:objects
	steve - agent
...
(:init
	...
	(at-x cobblestone-block0 position-4)

	(at-y cobblestone-block0 position4)

	(at-z cobblestone-block0 position2)
	...
	(at-x cobblestone-block2 position-3)
	...
	(at-x diamond0 position-5)

	(at-y diamond0 position4)

	(at-z diamond0 position0)
	...
	(is-any-item-at-position position-5 position4 position0)
	...
	(is-any-block-at-position position-4 position4 position2)
	...
	(is-any-block-at-position position-3 position4 position2)
	...
	(is-any-block-at-position position-1 position4 position0)

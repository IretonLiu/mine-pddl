(define (problem Build_Wall_Easy_problem)
	(:domain Build_Wall_Easy)
(:objects
	steve - agent
	log0 log1 log2 log3 log4 log5 - log
	log-block0 log-block1 log-block2 log-block3 log-block4 log-block5 - log-block
	planks0 planks1 - planks
	planks-block0 planks-block1 - planks-block
	cobblestone0 - cobblestone
	cobblestone-block0 - cobblestone-block
...
(:init
	...
	(agent-alive steve)
	(agent-has-n-stone steve count5)
	...
	(at-x planks-block0 position-5)

	(at-y planks-block0 position4)

	(at-z planks-block0 position2)
	...
	(at-x log-block1 position-2)

	(at-y log-block1 position4)

	(at-z log-block1 position-1)

	(block-present log-block1)
	(at-x log-block2 position-2)
	...
	(at-x log-block3 position0)

	(at-y log-block3 position4)

	(at-z log-block3 position-4)

	(block-present log-block3)
	(at-x log-block4 position1)

	(at-y log-block4 position4)

	(at-z log-block4 position3)

	(block-present log-block4)
	(at-x log-block5 position4)

	(at-y log-block5 position4)

	(at-z log-block5 position-3)

	(block-present log-block5)
	(at-x cobblestone-block0 position-3)

	(at-y cobblestone-block0 position5)

	(at-z cobblestone-block0 position-3)
	...
	(is-any-block-at-position position-5 position4 position2)
	...
	(is-any-block-at-position position-3 position4 position-3)

	(is-any-block-at-position position-3 position5 position-3)
	...
	(is-any-block-at-position position-2 position4 position3)
	...
	(is-any-block-at-position position0 position4 position3)
	...
	(is-any-block-at-position position4 position4 position-3)

...
(:types
	...
	log ladder gravel oak_door farmland cobblestone_stairs flower glass fence leaves torch dirt grass water wheat_seeds grass_block cobblestone chest planks - item
	log-block ladder-block gravel-block oak_door-block farmland-block cobblestone_stairs-block flower-block glass-block fence-block leaves-block torch-block dirt-block grass-block water-block wheat_seeds-block grass_block-block cobblestone-block chest-block planks-block - destructible-block
)
(:predicates
...
(:action checkgoal
	:parameters (?ag - agent ?b1 - block ?b2 - block ?b3 - block ?b4 - block ?b5 - block ?b6 - block ?b7 - block ?b8 - block ?b9 - block)
	:precondition (and 
(agent-alive ?ag)
 (and 
(block-present ?b1)

(define (problem Build_Wall_Medium_problem)
	(:domain Build_Wall_Medium)
(:objects
	steve - agent
	...
	stone_bricks0 stone_bricks1 - stone_bricks
	stone_bricks-block0 stone_bricks-block1 - stone_bricks-block
	...
	stone0 stone1 - stone
	stone-block0 stone-block1 - stone-block
...
(:init
	...
	(at-x log-block0 position-4)

	(at-y log-block0 position4)

	(at-z log-block0 position-5)

	(block-present log-block0)
	(at-x log-block1 position-4)

	(at-y log-block1 position5)

	(at-z log-block1 position-4)
	...
	(at-x log-block3 position-2)

	(at-y log-block3 position4)

	(at-z log-block3 position3)

	(block-present log-block3)
	(at-x log-block4 position-2)

	(at-y log-block4 position6)
	...
	(at-z stone-block0 position-4)

	(block-present stone-block0)
	(at-x stone-block1 position4)

	(at-y stone-block1 position4)

	(at-z stone-block1 position-1)

	(block-present stone-block1)
	(at-x wool-block0 position-2)
	...
	(at-z wool-block1 position3)

	(block-present wool-block1)
	(at-x wool-block2 position4)

	(at-y wool-block2 position5)

	(at-z wool-block2 position-1)

	(block-present wool-block2)
	(at-x stone_bricks-block0 position0)

	(at-y stone_bricks-block0 position4)

	(at-z stone_bricks-block0 position-5)
	...
	(at-z stone_bricks-block1 position-4)
	...
	(is-any-block-at-position position-4 position4 position-5)

	(is-any-block-at-position position-4 position4 position-4)

	(is-any-block-at-position position-4 position5 position-4)
	...
	(is-any-block-at-position position-2 position5 position3)
	...
	(is-any-block-at-position position4 position5 position-1)

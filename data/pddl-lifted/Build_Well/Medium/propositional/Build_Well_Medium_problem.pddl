...
(:init
	...
	(is-any-block-at-position position-6 position4 position-1)

	(is-any-block-at-position position-6 position4 position3)

	(is-any-block-at-position position-6 position5 position3)
	...
	(is-any-block-at-position position-5 position4 position-2)

	(is-any-block-at-position position-5 position4 position-1)

	(is-any-block-at-position position-5 position4 position3)

	(is-any-block-at-position position-5 position5 position3)

	(is-any-block-at-position position-5 position6 position3)
	...
	(is-any-block-at-position position-4 position4 position3)

	(is-any-block-at-position position-4 position5 position3)
	...
	(is-any-block-at-position position-3 position5 position1)
	...
	(is-any-block-at-position position-2 position5 position-4)
	...
	(is-any-block-at-position position1 position5 position-2)

	(is-any-block-at-position position1 position6 position-2)
	...
	(is-any-block-at-position position2 position4 position-2)

	(is-any-block-at-position position2 position4 position-1)
	...
	(is-any-block-at-position position3 position4 position3)
	...
	(is-any-block-at-position position5 position4 position-3)

	(is-any-block-at-position position5 position4 position-2)

	(is-any-block-at-position position5 position5 position-3)
	...
	(is-any-block-at-position position6 position4 position-2)

	(is-any-block-at-position position6 position4 position1)

	(is-any-block-at-position position6 position4 position2)

	(is-any-block-at-position position6 position4 position3)

	(is-any-block-at-position position6 position5 position1)
	...
	(is-any-block-at-position position7 position4 position1)

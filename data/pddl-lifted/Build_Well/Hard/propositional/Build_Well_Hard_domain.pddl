...
(:types
	...
	cobblestone_stairs flower water glass fence grass_block cobblestone oak_door grass gravel dirt wheat_seeds chest planks glowstone log leaves farmland ladder torch - item
	cobblestone_stairs-block flower-block water-block glass-block fence-block grass_block-block cobblestone-block oak_door-block grass-block gravel-block dirt-block wheat_seeds-block chest-block planks-block glowstone-block log-block leaves-block farmland-block ladder-block torch-block - destructible-block
)
(:predicates

...
(:init
	...
	(at-x oak_stairs-block0 position2)

	(at-y oak_stairs-block0 position4)

	(at-z oak_stairs-block0 position0)

	(block-present oak_stairs-block0)
	(at-x oak_stairs-block1 position3)

	(at-y oak_stairs-block1 position5)

	(at-z oak_stairs-block1 position0)

	(block-present oak_stairs-block1)
	(at-x oak_stairs-block2 position4)

	(at-y oak_stairs-block2 position6)

	(at-z oak_stairs-block2 position0)

	(block-present oak_stairs-block2)
	(at-x oak_stairs-block3 position5)

	(at-y oak_stairs-block3 position7)

	(at-z oak_stairs-block3 position0)
	...
	(is-any-block-at-position position3 position5 position0)
	...
	(is-any-block-at-position position4 position6 position0)
	...
	(is-any-block-at-position position5 position5 position0)

	(is-any-block-at-position position5 position6 position0)

	(is-any-block-at-position position5 position7 position0)
	...
	(is-any-block-at-position position6 position5 position0)

	(is-any-block-at-position position6 position6 position0)

	(is-any-block-at-position position6 position7 position0)

...
(:types
	...
	oak_wood_stairs wool cobblestone planks grass_block - item
	oak_wood_stairs-block wool-block cobblestone-block planks-block grass_block-block - destructible-block
)
(:predicates
	...
	(agent-has-n-wool ?ag - agent ?n - count)
	(item-present ?i - item)
	(at-z ?l - locatable ?z - position)
	(agent-has-n-oak_wood_stairs ?ag - agent ?n - count)
...
(:action break-oak_wood_stairs-north
	:parameters (?ag - agent ?b - oak_wood_stairs-block ?x - position ?y - position ?z - position ?z_front - position ?n_start - count ?n_end - count)
	:precondition (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
 (at-z ?ag ?z)
 ...
 (agent-has-n-oak_wood_stairs ?ag ?n_start)
)
	:effect (and 
(not (block-present ?b)) (not (at-x ?b ?x)
) (not (at-y ?b ?y)
) (not (at-z ?b ?z_front)
) (not (agent-has-n-oak_wood_stairs ?ag ?n_start)
) (agent-has-n-oak_wood_stairs ?ag ?n_end)
)
)


(:action place-oak_wood_stairs-north
	:parameters (?ag - agent ?b - oak_wood_stairs-block ?x - position ?y - position ?y_down - position ?z - position ?z_front - position ?n_start - count ?n_end - count)
	:precondition (and 
(exists (?bl - block) (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
...
(:action move_and_pickup-oak_wood_stairs-north
	:parameters (?ag - agent ?i - oak_wood_stairs ?x - position ?y_up - position ?y_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action jumpup_and_pickup-oak_wood_stairs-north
	:parameters (?ag - agent ?i - oak_wood_stairs ?x - position ?y_up - position ?y_up_up - position ?y_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action jumpdown_and_pickup-oak_wood_stairs-north
	:parameters (?ag - agent ?i - oak_wood_stairs ?x - position ?y_up - position ?y_down - position ?y_2_down - position ?y_3_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action break-wool-north
	:parameters (?ag - agent ?b - wool-block ?x - position ?y - position ?z - position ?z_front - position ?n_start - count ?n_end - count)
	:precondition (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
 (at-z ?ag ?z)
 ...
 (are-seq ?z_front ?z)
 (block-present ?b) (are-seq ?n_start ?n_end)
 (agent-has-n-wool ?ag ?n_start)
)
	:effect (and 
(not (block-present ?b)) (not (at-x ?b ?x)
) (not (at-y ?b ?y)
) (not (at-z ?b ?z_front)
) (not (agent-has-n-wool ?ag ?n_start)
) (agent-has-n-wool ?ag ?n_end)
)
)


(:action place-wool-north
	:parameters (?ag - agent ?b - wool-block ?x - position ?y - position ?y_down - position ?z - position ?z_front - position ?n_start - count ?n_end - count)
	:precondition (and 
(exists (?bl - block) (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
...
(:action move_and_pickup-wool-north
	:parameters (?ag - agent ?i - wool ?x - position ?y_up - position ?y_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action jumpup_and_pickup-wool-north
	:parameters (?ag - agent ?i - wool ?x - position ?y_up - position ?y_up_up - position ?y_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action jumpdown_and_pickup-wool-north
	:parameters (?ag - agent ?i - wool ?x - position ?y_up - position ?y_down - position ?y_2_down - position ?y_3_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action break-cobblestone-north
	:parameters (?ag - agent ?b - cobblestone-block ?x - position ?y - position ?z - position ?z_front - position ?n_start - count ?n_end - count)
	:precondition (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
 (at-z ?ag ?z)
...
(:action move_and_pickup-cobblestone-north
	:parameters (?ag - agent ?i - cobblestone ?x - position ?y_up - position ?y_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action break-planks-north
	:parameters (?ag - agent ?b - planks-block ?x - position ?y - position ?z - position ?z_front - position ?n_start - count ?n_end - count)
	:precondition (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
 (at-z ?ag ?z)
...
(:action move_and_pickup-planks-north
	:parameters (?ag - agent ?i - planks ?x - position ?y_up - position ?y_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action move_and_pickup-grass_block-north
	:parameters (?ag - agent ?i - grass_block ?x - position ?y_up - position ?y_down - position ?z_start - position ?z_end - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x)
 (at-y ?ag ?y_down)
...
(:action break-oak_wood_stairs-east
	:parameters (?ag - agent ?b - oak_wood_stairs-block ?x - position ?x_front - position ?y - position ?z - position ?n_start - count ?n_end - count)
	:precondition (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
 (at-z ?ag ?z)
...
(:action place-oak_wood_stairs-east
	:parameters (?ag - agent ?b - oak_wood_stairs-block ?x - position ?x_front - position ?y - position ?y_down - position ?z - position ?n_start - count ?n_end - count)
	:precondition (and 
(exists (?bl - block) (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
...
(:action move_and_pickup-oak_wood_stairs-east
	:parameters (?ag - agent ?i - oak_wood_stairs ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_down - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
...
(:action jumpup_and_pickup-oak_wood_stairs-east
	:parameters (?ag - agent ?i - oak_wood_stairs ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_up_up - position ?y_down - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
...
(:action jumpdown_and_pickup-oak_wood_stairs-east
	:parameters (?ag - agent ?i - oak_wood_stairs ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_down - position ?y_2_down - position ?y_3_down - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
...
(:action break-wool-east
	:parameters (?ag - agent ?b - wool-block ?x - position ?x_front - position ?y - position ?z - position ?n_start - count ?n_end - count)
	:precondition (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
 (at-z ?ag ?z)
...
(:action place-wool-east
	:parameters (?ag - agent ?b - wool-block ?x - position ?x_front - position ?y - position ?y_down - position ?z - position ?n_start - count ?n_end - count)
	:precondition (and 
(exists (?bl - block) (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
...
(:action move_and_pickup-wool-east
	:parameters (?ag - agent ?i - wool ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_down - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
...
(:action jumpup_and_pickup-wool-east
	:parameters (?ag - agent ?i - wool ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_up_up - position ?y_down - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
...
(:action jumpdown_and_pickup-wool-east
	:parameters (?ag - agent ?i - wool ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_down - position ?y_2_down - position ?y_3_down - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
...
(:action break-cobblestone-east
	:parameters (?ag - agent ?b - cobblestone-block ?x - position ?x_front - position ?y - position ?z - position ?n_start - count ?n_end - count)
	:precondition (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
 (at-z ?ag ?z)
...
(:action move_and_pickup-cobblestone-east
	:parameters (?ag - agent ?i - cobblestone ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_down - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
...
(:action break-planks-east
	:parameters (?ag - agent ?b - planks-block ?x - position ?x_front - position ?y - position ?z - position ?n_start - count ?n_end - count)
	:precondition (and 
(at-x ?ag ?x)
 (at-y ?ag ?y)
 (at-z ?ag ?z)
...
(:action move_and_pickup-planks-east
	:parameters (?ag - agent ?i - planks ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_down - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
...
(:action move_and_pickup-grass_block-east
	:parameters (?ag - agent ?i - grass_block ?z - position ?x_start - position ?x_end - position ?y_up - position ?y_down - position ?n_start - count ?n_end - count)
	:precondition (and 
(agent-alive ?ag)
 (at-x ?ag ?x_start)
 (at-y ?ag ?y_down)
